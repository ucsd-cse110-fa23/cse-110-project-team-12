...
// Mock ChatGPT to use for testing, onstruced with integer to set the model response
public class MockChatGPT implements ChatGPTInterface {
	 ...
	 * 
	 * @param mealType mealType is not used but needs to be passed in to match the interface
	 * @param ingredients ingredients is not used but needs to be passed in to match the interface
	 * 
